...
BCH::BCH() {
    // p = (int8_t *) calloc(m, sizeof(int8_t));
    // alpha_to = (int8_t *) calloc(pow(2, m), sizeof(int8_t));
    // index_of = (int8_t *) calloc(pow(2, m), sizeof(int8_t));
    // g = (int8_t *) calloc((n - k), sizeof(int8_t));
    tools = Tools();
}
