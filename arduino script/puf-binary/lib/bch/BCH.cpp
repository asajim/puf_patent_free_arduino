...
BCH::BCH() {
    p = (int8_t*)malloc(sizeof(int8_t)*m);
    alpha_to = (int8_t*)malloc(sizeof(int8_t)*pow(2,m));
    index_of = (int8_t*)malloc(sizeof(int8_t)*pow(2,m));
    g = (int8_t*)malloc(sizeof(int8_t)*(n-k));
}
...
void
BCH::encode_bch(const int8_t *input, int8_t *result)
/*
...
void
BCH::decode_bch(int8_t *input, int8_t *result)
/*
