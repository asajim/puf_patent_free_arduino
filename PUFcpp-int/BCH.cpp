...
BCH::BCH() {
    p = (int*)malloc(sizeof(int)*21);
    alpha_to = (int*)malloc(sizeof(int)*512);
    index_of = (int*)malloc(sizeof(int)*512);
    g = (int*)malloc(sizeof(int)*481);
}
...
void
BCH::encode_bch(int *input, int *result)
/*
 ...
 */
{
    ...
    memcpy(result, bb, sizeof(int) * (n - k));
    memcpy(&result[n - k], input, sizeof(int) * k);
}


void
BCH::decode_bch(int *input, int *result)
/*
 ...
 */
{
    ...
    memcpy(result, &input[n - k], sizeof(int) * k);
}
